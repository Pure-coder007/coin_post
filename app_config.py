...
def get_database_uri():
    ...
    default_uri = "postgresql://{user}:{password}@{host}/{dbname}".format(
        user="noviaxch_user1",
        password="database_password",
        host="noviaxchange.com",
        dbname="noviaxch_database1"
    )
...
def create_app():
    ...
    app.config.update(
        ...
        SECRET_KEY=os.getenv("SECRET_KEY", "4f557e8e5eb51bfb7c42"),
        DEBUG=False,
